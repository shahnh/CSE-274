...
public class LinkedBagDemo
{
	public static void main(String[] args) 
	{
		...
		BagInterfaceExtension<String> aBag = new LinkedBag<>();
		displayBag(aBag);
	...
	private static void testAdd(BagInterfaceExtension<String> aBag, String[] content)
	{
	...
	private static void testRemove(BagInterfaceExtension<String> aBag, String[] tests)
	{
	...
	private static void testIsEmpty(BagInterfaceExtension<String> aBag, boolean correctResult)
	{
	...
	private static void testFrequency(BagInterfaceExtension<String> aBag, String[] tests)
	{
	...
	private static void testContains(BagInterfaceExtension<String> aBag, String[] tests)
	{
	...
	private static void displayBag(BagInterfaceExtension<String> aBag)
	{
